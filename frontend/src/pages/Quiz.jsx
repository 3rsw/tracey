      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col s6">
            <Code code={qn.code} lineNum={lineNum} branches={branches} boxes={boxes} fetchNextStep={fetchNextStep} fetchPrevStep={fetchPrevStep} allVarsHaveAttempt={allVarsHaveAttempt} mode={"quiz"}/>
          </div>
          <div className="col s6">
